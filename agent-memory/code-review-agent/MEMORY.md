...
| `lib/features/pdf/services/extraction/stages/row_classifier_v2.dart` [FILE REMOVED] | 2 reviews | Entire file dead (V3 active), removed |
...
| `lib/main.dart` | 1 review | 222 lines (post-refactor), service locator refactored |
