# CODEX Production Readiness Plan (Verified + Updated)
...
- Phase 8: M (shared widgets/utilities)
...
**Goal**: Implement Session 3 DRY/KISS items.
...
- Centralize `SharedPreferences.getInstance()` calls into providers/services (seen in `lib/features/entries/presentation/screens/report_screen.dart`, `lib/features/entries/presentation/screens/entry_wizard_screen.dart`, `lib/features/entries/presentation/screens/home_screen.dart`).
- Reuse shared confirmation/permission dialogs instead of inline dialog duplication: `lib/shared/widgets/confirmation_dialog.dart`, `lib/shared/widgets/permission_dialog.dart` vs inline dialogs in `lib/features/entries/presentation/screens/report_screen.dart` and `lib/features/entries/presentation/screens/entry_wizard_screen.dart`.
- Consolidate repeated “empty state” UI blocks into shared widgets (existing shared widgets folder: `lib/shared/widgets/`; duplicated in `lib/features/projects/presentation/screens/project_list_screen.dart`, `lib/features/entries/presentation/screens/entries_list_screen.dart`, `lib/features/quantities/presentation/screens/quantities_screen.dart`, `lib/features/entries/presentation/screens/home_screen.dart`).
- Normalize repeated date/number formatting into shared utilities (see repeated `DateFormat` usage across `lib/features/entries/presentation/screens/report_screen.dart`, `lib/features/entries/presentation/screens/home_screen.dart`, `lib/features/entries/presentation/screens/entries_list_screen.dart`, `lib/features/quantities/presentation/screens/quantities_screen.dart`).
- Consolidate SnackBar patterns into a helper to reduce duplication (many `ScaffoldMessenger.of(context).showSnackBar` in `lib/features/entries/presentation/screens/report_screen.dart`, `lib/features/entries/presentation/screens/entry_wizard_screen.dart`, `lib/features/quantities/presentation/screens/quantities_screen.dart`, `lib/features/projects/presentation/screens/project_setup_screen.dart`, `lib/features/settings/presentation/screens/settings_screen.dart`).
