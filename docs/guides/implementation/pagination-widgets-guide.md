...
> **Used By**: [frontend-flutter-specialist-agent](../../../agents/frontend-flutter-specialist-agent.md) for infinite scroll list implementation across dashboard, entries, contractors, and other list-based features
